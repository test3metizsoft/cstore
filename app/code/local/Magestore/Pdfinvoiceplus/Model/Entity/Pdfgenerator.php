...
//        return '$filename';
    ...
    public function loadPdf() {
                $orderId =Mage::app()->getRequest()->getParam('invoice_id');
		if(!$orderId){
			$postData = Mage::app()->getRequest()->getPost('order_ids');
			$orderId = $postData[0]; 
		}
		if(count($postData) == 1 || Mage::app()->getRequest()->getParam('invoice_id')){
    ...
    <div class="myheader-iv" style="padding-top: 5px; padding-bottom: 20px;">
        ...
        <div class="bottom-header-iv" contextmenu-type="main">
            <div class="id-invoice-iv">
                ...
                <span class="color-text contenteditable" title="Click to edit, right-click to insert variable" style="color: #010101; font-size: 26px;">#'.$incrementId .'</span><br />
                <span class="color-text contenteditable" title="Click to edit, right-click to insert variable" style="color: #010101; font-size: 18px;">'.$createdAt.'</span></div>
                <!--Edit by Zeus 15/01/2014-->
                <div class="status color-text contenteditable" contextmenu-type="main" title="Click to edit, right-click to insert variable" style="margin-top: 5px;"><span style="font-weight: bold;">Status: </span> '.$status.'<span style="font-weight: bold;"><br />Payment:</span> '.$payment.'</div>
                <!--end edit--></div>
            <div title="Click to edit..." contextmenu-type="main" class="box-infomations autogrow info-iv contenteditable"><span class="title-color" title="Click to edit, right-click to insert variable" style="display: block; font-weight: bold; font-size: 18px; color: #cc0000; width: 100%; float: left; font-family: "Ubuntu"; text-transform: uppercase;" info-text="company_name">CSTOREMASTER</span><br />
            <span class="color-text" title="Click to edit, right-click to insert variable" style="display: block; font-size: 14px; width: 100%; float: left;"><strong>Address: </strong><info info-text="company_address">4320 University Dr , Huntsville , AL 5816<br>Call : 1-844-EZ CSTORE Fax : (256) 513-4880 http://cstoremaster.com</info></span></div>
        </div>
    </div>
        ...
        <div class="top-main-if">
            <div class="info-cus">
                <div class="billing-box">
                    <div class="title1"><span title="Click to edit, right-click to insert variable" class="contenteditable title-color title-label">Address</span></div>
                    <div class="content contenteditable"><address contextmenu-type="main" title="Click to edit, right-click to insert variable">'.$address.'</address></div>
                </div>
                <div class="shipping-add-box">
                    <div class="title1"><span title="Click to edit, right-click to insert variable" class="title-color title-label contenteditable"><span title="Click to edit..." class="contenteditable title-color title-label">Shipping Method</span></span></div>
                    <div class="content contenteditable">'.$shippingmethod.'</div>
                </div>
            </div>
            <div class="info-cus" style="margin-top: 10px; margin-bottom: 10px;">
