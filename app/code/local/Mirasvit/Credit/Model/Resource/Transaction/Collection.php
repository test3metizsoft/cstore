...
class Mirasvit_Credit_Model_Resource_Transaction_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    ...
    protected function _joinBalance()
    {
        $this->getSelect()->joinLeft(
            array('balance' => $this->getTable('credit/balance')),
