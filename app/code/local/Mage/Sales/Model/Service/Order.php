        ...
        foreach ($this->_order->getAllItems() as $orderItem) {
            ...
            if ($orderItem->isDummy(true)) {
                ...
                if (isset($qtys[$orderItem->getParentItemId()])) {
                    ...
                    {
                        //Boostmyshop tweak to add configurable child in shipment
                        //if there is a parent and no bundle selection, apply parend quantity (used for configurable products)
