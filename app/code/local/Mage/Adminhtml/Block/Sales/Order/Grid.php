...
class Mage_Adminhtml_Block_Sales_Order_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->join(array('Shipping'=>'sales_flat_order_address'),
                ...
                array('city','company','street','telephone','postcode','region','entityname','statecounty'));
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('entityname', array(
            'header' => Mage::helper('sales')->__('Entity name'),
            'index' => 'entityname',
        ));
        ...
        $this->addColumn('address', array(
            ...
            'index' => 'street',
            'renderer'  => new Metizsoft_Taxgenerate_Block_Adminhtml_Renderer_OrderAddressGrid(),
        ));
