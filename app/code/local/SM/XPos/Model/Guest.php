...
class SM_XPos_Model_Guest extends Mage_Core_Model_Abstract {
    ...
    {
        return Mage::getStoreConfig('xpos/checkout/default_customer_id');
    }
    ...
    public function getDefaultCustomer() {
        ...
        $customerShippingAddressId = $this->_sourceCustomer->getDefaultShipping();
        $customerBillingAddressId = $this->_sourceCustomer->getDefaultBilling();
        ...
        $customerData = array(
            ...
            'billing_address' => array(
                ...
                'prefix' => '',
                'firstname'           => $billingAddress->getData('firstname')==''?$this->_sourceCustomer->getFirstname():$billingAddress->getData('firstname'),
                'middlename' => '',
                'lastname'            => $billingAddress->getData('lastname')==''?$this->_sourceCustomer->getLasttname():$billingAddress->getData('lastname'),
                'suffix' => '',
                'company'             => $this->_customerBillingAdd->getCompany(),/*s*/
                ...
                'statecounty'         => $this->_customerBillingAdd->getStatecounty(),/*s*/
                'postcode' => $this->_customerBillingAdd->getPostcode(),/*s*/
                'outofcityarea'       => $this->_customerBillingAdd->getOutofcityarea(),/*s*/
            ...
            'shipping_address' => array(
                'customer_address_id' => $this->_sourceCustomer->getCustomerAddressId(),
                'prefix' => '',
                'firstname'           => $shippingAddress->getData('firstname')==''?$this->_sourceCustomer->getFirstname():$shippingAddress->getData('firstname'),
                'middlename' => '',
                'lastname'            => $shippingAddress->getData('lastname')==''?$this->_sourceCustomer->getLastname():$shippingAddress->getData('lastname'),
                'suffix' => '',
                'company'             => $this->_customerShippingAdd->getCompany(),
...
//        $this->helper('customer/address')->getStreetLines();
    ...
    public function getReloadBillingAdd($customer)
    {
