...
class Metizsoft_Reports_Model_Mysql4_Report_Collection
    extends Mage_Core_Model_Mysql4_Collection_Abstract
{
     ...
     * @return Metizsoft_Reports_Model_Mysql4_Report_Collection
     */
     ...
     * @return bool|Metizsoft_Reports_Model_Mysql4_Report_Collection
     */
    ...
    public function isTotals($bool = null)
    {
      ...
      //  echo "<pre>";print_r($this->_isTotals);die();
        return $this;
