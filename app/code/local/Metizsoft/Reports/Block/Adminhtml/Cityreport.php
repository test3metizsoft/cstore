...
class Metizsoft_Reports_Block_Adminhtml_Cityreport
    extends Mage_Adminhtml_Block_Widget_Grid_Container
{
     ...
     */
    protected $_controller      = 'adminhtml_cityreport';
    ...
    public function __construct()
    {
        ...
        $this->_headerText = Mage::helper('metizsoft_reports')->__('City Reports');
    ...
    public function getFilterUrl()
    {
        ...
        return $this->getUrl('*/*/cityreport', array('_current' => true));
    }
}