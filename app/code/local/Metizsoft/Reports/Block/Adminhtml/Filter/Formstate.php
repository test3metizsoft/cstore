...
class Metizsoft_Reports_Block_Adminhtml_Filter_Formstate extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        $fieldset->addField('register', 'button', array(
            'onclick'   => 'setLocation(\'' . $this->getUrl('*/*/resetalldata?report=statereport') . '\')',
