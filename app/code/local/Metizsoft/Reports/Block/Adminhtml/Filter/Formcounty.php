...
class Metizsoft_Reports_Block_Adminhtml_Filter_Formcounty extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        $fieldset->addField('register', 'button', array(
            'onclick'   => 'setLocation(\'' . $this->getUrl('*/*/resetalldata?report=countyreport') . '\')',
        ...
        foreach ($countylist as $county) {
            $j = $j + 1;
            $countylistarray[$j]['value'] = $county['value'];
