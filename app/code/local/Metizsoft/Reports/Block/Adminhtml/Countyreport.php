...
class Metizsoft_Reports_Block_Adminhtml_Countyreport
    extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    /**
     * This is your module alias
     */
    protected $_blockGroup      = 'metizsoft_reports';
    /**
     * This is the controller's name (this block)
     */
    protected $_controller      = 'adminhtml_countyreport';

    /*
        Note: the grid block's name would prepare from $_blockGroup and $_controller with the suffix '_grid'.
        So the complete block would called metizsoft_reports/adminhtml_report_grid . As you already guessed it,
        this will resolve to the class Metizsoft_Reports_Adminhtml_Report_Grid .
     */
    ...
    public function __construct()
    {
        ...
        $this->_headerText = Mage::helper('metizsoft_reports')->__('County Reports');
        ...
        $this->addButton('filter_form_submit', array(
            'label'     => Mage::helper('metizsoft_reports')->__('Show Report'),
    ...
    public function getFilterUrl()
    {
        ...
        return $this->getUrl('*/*/countyreport', array('_current' => true));
    }
}