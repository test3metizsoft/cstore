...
class Metizsoft_Reports_Block_Adminhtml_Statereport
    extends Mage_Adminhtml_Block_Widget_Grid_Container
{
     ...
     */
    protected $_controller      = 'adminhtml_statereport';
    ...
    public function __construct()
    {
        ...
        $this->_headerText = Mage::helper('metizsoft_reports')->__('State Reports');
    ...
    public function getFilterUrl()
    {
        ...
        return $this->getUrl('*/*/statereport', array('_current' => true));
    }
}