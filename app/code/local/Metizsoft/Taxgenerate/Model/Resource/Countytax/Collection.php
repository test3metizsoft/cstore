 ...
 */
class Metizsoft_Taxgenerate_Model_Resource_Countytax_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    ...
    protected function _renderFiltersBefore()
    {
        if ($this->getFilter('store')) {
            $this->getSelect()->join(
                array('store_table' => $this->getTable('metizsoft_taxgenerate/countytax_store')),
