 ...
 */
/**
 * Statetax admin grid block
 *
 * @category    Metizsoft
 * @package     Metizsoft_Taxgenerate
 * @author      Metizsoft Solutions<http://metizsoft.com>
 */
class Metizsoft_Taxgenerate_Block_Adminhtml_Statetax_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * constructor
     *
     ...
     *
     * @access protected
     * @return Metizsoft_Taxgenerate_Block_Adminhtml_Statetax_Grid
     * @author Metizsoft Solutions
     */
    protected function _prepareCollection()
    {
        $collection = Mage::getModel('metizsoft_taxgenerate/statetax')
            ->getCollection();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            'state_tax',
            array(
                'header' => Mage::helper('metizsoft_taxgenerate')->__('State Tax Amt'),
                'index'  => 'state_tax',
                'type'=> 'text',
        ...
        /*$this->addColumn(
            'zipcode',
            array(
                'header' => Mage::helper('metizsoft_taxgenerate')->__('City Zipcode'),
                'index'  => 'zipcode',
                'type'=> 'text',
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->setFormFieldName('statetax');
            ...
            array(
                ...
                'additional' => array(
                    'flag_state' => array(
                        ...
                        'values' => Mage::getModel('metizsoft_taxgenerate/statetax_attribute_source_state')
                            ->getAllOptions(true),
     ...
     *
     * @access public
     * @param Metizsoft_Taxgenerate_Model_Statetax
     * @return string
     * @author Metizsoft Solutions
     */
     ...
     *
     * @access protected
     * @param Metizsoft_Taxgenerate_Model_Resource_Statetax_Collection $collection
