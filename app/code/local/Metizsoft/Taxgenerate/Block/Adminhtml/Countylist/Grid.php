 ...
 */
/**
 * Countylist admin grid block
 *
 * @category    Metizsoft
 * @package     Metizsoft_Taxgenerate
 * @author      Metizsoft Solutions<http://metizsoft.com>
 */
class Metizsoft_Taxgenerate_Block_Adminhtml_Countylist_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * constructor
     *
     ...
     *
     * @access protected
     * @return Metizsoft_Taxgenerate_Block_Adminhtml_Countylist_Grid
     * @author Metizsoft Solutions
     */
    protected function _prepareCollection()
    {
        $collection = Mage::getModel('metizsoft_taxgenerate/countylist')
            ->getCollection();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            'name',
            array(
                'header'    => Mage::helper('metizsoft_taxgenerate')->__('Name'),
                'align'     => 'left',
                'index'     => 'name',
            )
        );
        ...
        $this->addColumn(
            'state',
            array(
                'header' => Mage::helper('metizsoft_taxgenerate')->__('State'),
                'index'  => 'state',
                'type'  => 'options',
                'options' => Mage::helper('metizsoft_taxgenerate')->convertOptions(
                    Mage::getModel('metizsoft_taxgenerate/countylist_attribute_source_state')->getAllOptions(false)
                )
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->setFormFieldName('countylist');
            ...
            array(
                ...
                'additional' => array(
                    'flag_state' => array(
                        ...
                        'values' => Mage::getModel('metizsoft_taxgenerate/countylist_attribute_source_state')
                            ->getAllOptions(true),
     ...
     *
     * @access public
     * @param Metizsoft_Taxgenerate_Model_Countylist
     * @return string
     * @author Metizsoft Solutions
     */
     ...
     *
     * @access protected
     * @param Metizsoft_Taxgenerate_Model_Resource_Countylist_Collection $collection
