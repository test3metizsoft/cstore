 ...
 */
class Metizsoft_Taxgenerate_Block_Adminhtml_Countylist_Edit_Tab_Stores extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * prepare the form
     *
     * @access protected
     * @return Metizsoft_Taxgenerate_Block_Adminhtml_Countylist_Edit_Tab_Stores
    ...
    protected function _prepareForm()
    {
        ...
        $form->addValues(Mage::registry('current_countylist')->getData());
