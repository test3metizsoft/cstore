 ...
 */
/**
 * Citytax admin grid block
 *
 * @category    Metizsoft
 * @package     Metizsoft_Taxgenerate
 * @author      Metizsoft Solutions<http://metizsoft.com>
 */
class Metizsoft_Taxgenerate_Block_Adminhtml_Citytax_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * constructor
     *
     ...
     *
     * @access protected
     * @return Metizsoft_Taxgenerate_Block_Adminhtml_Citytax_Grid
     * @author Metizsoft Solutions
     */
    protected function _prepareCollection()
    {
        $collection = Mage::getModel('metizsoft_taxgenerate/citytax')
            ->getCollection();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            array(
                ...
                'options' => Mage::helper('metizsoft_taxgenerate')->convertOptions(
                    Mage::getModel('metizsoft_taxgenerate/statetax_attribute_source_state')->getAllOptions(false)
                )
        ...
        $this->addColumn(
            ...
            array(
                ...
                'type'  => 'options',
                'options' => Mage::helper('metizsoft_taxgenerate')->convertOptions(
                    Mage::getModel('metizsoft_taxgenerate/citytax_attribute_source_county')->getAllOptions(false)
                )
        ...
        $this->addColumn(
            ...
            array(
                ...
                'type'  => 'options',
                'options' => Mage::helper('metizsoft_taxgenerate')->convertOptions(
                    Mage::getModel('metizsoft_taxgenerate/statetax_attribute_source_city')->getAllOptions(false)
                )
        ...
        $this->addColumn(
            'city_tax',
            array(
                'header' => Mage::helper('metizsoft_taxgenerate')->__('City Tax Amt'),
                'index'  => 'city_tax',
                'type'=> 'text',
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->setFormFieldName('citytax');
            ...
            array(
                ...
                'additional' => array(
                    'flag_county' => array(
                        ...
                        'values' => Mage::getModel('metizsoft_taxgenerate/citytax_attribute_source_county')
                            ->getAllOptions(true),
     ...
     *
     * @access public
     * @param Metizsoft_Taxgenerate_Model_Citytax
     * @return string
     * @author Metizsoft Solutions
     */
     ...
     *
     * @access protected
     * @param Metizsoft_Taxgenerate_Model_Resource_Citytax_Collection $collection
