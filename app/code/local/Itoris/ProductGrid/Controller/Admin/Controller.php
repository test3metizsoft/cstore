...
class Itoris_ProductGrid_Controller_Admin_Controller extends Mage_Adminhtml_Controller_Action {
	...
	public function preDispatch() {
		...
		if (!Itoris_Installer_Client::isAdminRegistered($helper->getAlias())) {
			...
			$register = $this->getLayout()->createBlock('itoris_productgrid/admin_register');
	...
	/**
	 * @return Itoris_ProductGrid_Helper_Data
	 */
	protected function getDataHelper() {
		return Mage::helper('itoris_productgrid');
	}
