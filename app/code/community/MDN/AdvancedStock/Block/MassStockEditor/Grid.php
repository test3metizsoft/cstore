...
class MDN_AdvancedStock_Block_MassStockEditor_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        ...
        if($manufacturerCode){
           $collection->getSelect()->joinLeft(array('AdvancedStock/CatalogProductInt' => Mage::getConfig()->getTablePrefix().'catalog_product_entity_int'),
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('status', array(
            ...
            'index' => 'item_id',
            'align' => 'center',
            'renderer' => 'MDN_AdvancedStock_Block_MassStockEditor_Widget_Grid_Column_Renderer_ProductStatus',
            'filter' => 'MDN_AdvancedStock_Block_MassStockEditor_Widget_Grid_Column_Filter_ProductStatus',
            'type' => 'options',
            'options' => array(
